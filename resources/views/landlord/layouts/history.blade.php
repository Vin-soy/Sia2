...
<div class="rentals-container">
    <div class="page-header">
        <div class="header-content">
            <h1>My Properties</h1>
            <a href="{{ route('landlord.account') }}" class="add-property-btn">
                <i class="bx bx-plus"></i> List new property
            </a>
        </div>
    </div>
        ...
        <div class="property-card">
            ...
            <div class="property-details">
                ...
                <div class="property-actions">
                    <a href="{{ route('rentals.show', $rental->id) }}" class="view-btn">View details</a>
